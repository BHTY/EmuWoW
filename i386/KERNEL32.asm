...
global InitializeCriticalSectionAndSpinCount
extern InitializeCriticalSectionAndSpinCount
export InitializeCriticalSectionAndSpinCount

InitializeCriticalSectionAndSpinCount:
	mov eax, THUNK_KERNEL32_INITIALIZECRITICALSECTIONANDSPINCOUNT
	int SYSCALL_THUNK
	ret 0x8
...
THUNK_KERNEL32_INITIALIZECRITICALSECTIONANDSPINCOUNT equ 0xe33
